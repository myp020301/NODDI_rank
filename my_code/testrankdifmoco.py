...
from testmodel_linear_modi_v4 import Mymodel
...
'''
model_name  = os.path.join(directory, "model_epoch_20.pth")
scales_txt_name =  os.path.join(directory , "scales.txt")
...
print("coe_dif_moco",coe_dif_moco)
...
if not os.path.exists(model_name):
    ...
    for epoch in range(epochs):
        ...
        for step, (batch_x, batch_y) in loop:
            ...
            loss3 = criterion_dif_moco(output, batch_y)
            loss = loss1  + coe_rank_moco * loss2  + coe_dif_moco * loss3
            loss.backward()
