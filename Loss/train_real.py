...
if __name__ == '__main__':
    ...
    parser.add_argument("-mepoch", dest="mepoch", help="Max epoch", type=int, default=4000)
    ...
    # 创建数据加载器
    train_loader = DataLoader(train_dataset_real, batch_size=args.batch_size, shuffle=True, num_workers=2)
    val_loader = DataLoader(val_dataset_real, batch_size=args.batch_size, shuffle=False, num_workers=2)
