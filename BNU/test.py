...
def main():
    ...
    parser.add_argument("--roi_probtrack_script", default="/data2/mayupeng/BNU/3_modi.py",
                        help="Path to the probtrack processing script")
    parser.add_argument("--roi_calc_matrix_script", default="/data2/mayupeng/BNU/4_modi.py",
                        help="Path to calc matrix processing script")
    parser.add_argument("--roi_parcellation_script", default="/data2/mayupeng/BNU/5_modi.py",
                        help="Path to parcellation processing script")
    parser.add_argument("--roi_toMNI_script", default="/data2/mayupeng/BNU/6_modi.py",
